...
public class Main {
    public static void main(String[] args) {
        ...
        employees[5] = new Employee("Груздь Поликарп Поликарппович", 4, 45_000);
        ...
        // реализуем метод выборки зп по отделам
            Employee.maxSalaryOfDepartment(employees, 1);
            System.out.println(Employee.getSeparator());
        // реализуем метод выборки зп по отделам
            Employee.minSalaryOfDepartment(employees, 4);
        // реализация метода нахождения суммы зп по отделам
            ...
            System.out.println(Employee.getSeparator());
        // реализация метода ннахождения среднего значения зп по отделу
